...
alias pbcopy2='xclip -selection clipboard'
...
pp (){
   ...
   echo '/'> .file2.txt
   echo $1 > .file3.txt
   cat .file1.txt .file2.txt .file3.txt | copy
...
asdfasdf(){
    cd /home/conor/mathematica/SystemFiles/FrontEnd/TextResources/X/
    sudo rm MenuSetup2.m
    sudo rm MenuSetup.tr
    sudo cp /media/conor/B10E-C7C1/02_PaletteFolder/MenuSetup2.m .
    sudo cp MenuSetup2.m MenuSetup.tr
    echo "done"
}
...
alias hilde="op ~/Dropbox/02*/Hild*"
...
alias t="clc;tree"
alias ttt="watch \"tree\""
alias realdata="cd /home/conor/Dropbox/intern_2_the_legacy/00_PAPERS_OF_THE_FIELD/00_data_folder"
...
alias mmaSetup="cd /Applications/Mathematica.app/Contents/SystemFiles/FrontEnd/TextResources/Macintosh/"
alias face="cd $HOME/face"
#alias init="au /Users/johncosnett/Library/Mathematica/Kernel/init.m"
alias init="o ~/.Mathematica/Kernel/init.m"
...
alias m="/home/conor/mathematica/WolframKernel" 
#***********************************************************************
...
#export ZSH=~/.oh-my-zsh;
#
#source ~/Dropbox/05_PROGRAMS/000_hyper_graph/hyperGraph0*
#source ~/Dropbox/05_PROGRAMS/000_hyper_graph/hyperGraph1*
#source ~/Dropbox/05_PROGRAMS/000_hyper_graph/hyperGraph2*
#source ~/Dropbox/05_PROGRAMS/000_hyper_graph/hyperGraph3*
#source ~/Dropbox/05_PROGRAMS/000_hyper_graph/hyperGraph4*
#
#export PATH="/home/$USER/addedToPath:$PATH"
